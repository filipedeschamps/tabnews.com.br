...
export default function Home({ contentListFound, pagination }) {
  ...
  Aqui você vai encontrar, **notícias**, **artigos**, **tutoriais**, **indicações**, **curiosidades** e dúvidas respondidas ou que você pode responder ordenadas pelo conteúdo mais antigo, veja também o nosso [FAQ](faq)
  ...
  return (
    <>
      <DefaultLayout
        metadata={{
          title: 'Antigos',
          description: 'Publicações no TabNews ordenadas pelas mais antigas.',
        }}>
      <Box>
        <Viewer value={body} />
      </Box>

        <ContentList contentList={contentListFound} pagination={pagination} paginationBasePath="/antigas/pagina" />
