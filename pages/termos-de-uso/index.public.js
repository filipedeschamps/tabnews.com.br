...
export default function Page() {
  ...
  3. Daremos preferência à **qualidade** sobre **quantidade**; neste ponto, especificamente, nosso objetivo é atingir um estágio onde **tudo o que você ler dentro do TabNews terá valor agregado**, de alguma forma.
  ...
  4. Da mesma forma, estão **estritamente proibido** atos discriminatórios de qualquer tipo, como homofobia, transfobia, xenofobia, capacitismo, discriminação pelo sexo, idade, raça, cor, classe social ou qualquer outra forma de segregação.
  ...
  1. O usuário possui os direitos autorais sobre os conteúdos que publicou na plataforma e se responsabiliza integralmente por eles, incluindo a declaração de que possui os direitos de uso do que for publicado ou está enquadrado dentro do "Fair Use" ("Limitação aos direitos de Autor" encontrado na \`LDA\`).
