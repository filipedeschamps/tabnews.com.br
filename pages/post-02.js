  ...
  return (
    <div className="relative w-full rounded-lg flex flex-col items-center justify-between dark:border-darkTheme-secondary">
      <div className="relative w-full rounded-lg flex flex-col items-start justify-between shadow-2xl dark:border-darkTheme-secondary">
        ...
        <div className="flex p-4 pt-0 font-sans z-10">
          <div className="flex-1 overflow-hidden">
            <div className="flex justify-end text-xs text-gray-400 w-full">
              <span className="font-semibold">filipedeschamps</span> | 45
              minutos atrás
            </div>
            ...
            <p className="text-gray-700">
              ...
              tão grande. Eu acho isso ótimo, mas sinceramente depois dos
              últimos anúncios acho que eles não estão nem aí. Para piorar,
              recentemente na Newsletter saiu que o crescimento do WhatsApp
              voltou a ser maior do que todos os outros aplicativos de
              mensageria.
            </p>

            <div className="flex items-center justify-between w-full mt-8">
              <div className="flex items-center shadow-md justify-start p-2 rounded-lg font-regular z-10 bg-gray-100">
                <AiOutlineComment
                  size={20}
                  className="mr-1 text-lightTheme-background-third"
                />
