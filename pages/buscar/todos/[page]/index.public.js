...
export default function SearchAll({ query, searchRuntime, contentListFound, pagination }) {
  return (
    <>
      <DefaultLayout
        metadata={{
          title: `Página ${pagination.currentPage || 1} · Buscar ${query}`,
          description: `Busca por "${query}" no TabNews ordenadas por todas.`,
        }}>
        ...
        <ContentList
          ...
          paginationBasePath={`/buscar/todos`}
        />
      </DefaultLayout>
    </>
  );
