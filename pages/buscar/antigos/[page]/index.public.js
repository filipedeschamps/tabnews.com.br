...
export default function SearchOlds({ query, searchRuntime, contentListFound, pagination }) {
  return (
    <>
      <DefaultLayout
        metadata={{
        ...
        <ContentList
          ...
          paginationBasePath={`/buscar/antigos`}
        />
      </DefaultLayout>
    </>
  );
...
export async function getServerSideProps(context) {
  ...
  try {
    const results = await search.findAll({ searchTerm: context.query.q, sortBy: 'old', page: context.params.page });
