...
Isto irá automaticamente rodar serviços como Banco de dados (sem as Migrations, [veja mais abaixo](#migrations)), Servidor de Email e irá expor um Serviço Web (Frontend e API) no seguinte endereço:
...
- Você pode conferir o endereço dos outros serviços dentro do arquivo `.env` encontrado na raiz do projeto, como por exemplo o endereço e credenciais do Banco de Dados local ou o Serviço de Email.

### Migrations

Após o comando acima e com os Serviços ainda rodando, você pode rodar as Migrations em um outro terminal utilizando o comando abaixo:
