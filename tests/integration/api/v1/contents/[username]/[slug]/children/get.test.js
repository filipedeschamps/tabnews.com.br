      ...
      expect(responseBody).toStrictEqual([
        {
          ...
          parent_username: rootBranchLevel0.owner_username,
          ...
          children: [
            {
              ...
              parent_username: childBranchBLevel1.owner_username,
          ...
          children: [
            {
              ...
              owner_id: firstUser.id,
              parent_id: childBranchALevel1.id,
              parent_title: childBranchALevel1.title,
              parent_slug: childBranchALevel1.slug,
              parent_username: childBranchALevel1.owner_username,
              ...
              children: [
                {
                  ...
                  owner_id: firstUser.id,
                  parent_id: childBranchALevel2.id,
                  parent_title: childBranchALevel2.title,
                  parent_slug: childBranchALevel2.slug,
                  parent_username: childBranchALevel2.owner_username,
